...
class Player:
    ...
    def add_score(self):
        self.score += 1
players = [
    Player((100,0,90), [Paddle(               5,   screen_size[1]/2-30,20,80, None,None,   K_s, K_w)]),
    Player((100,80,155), [Paddle(screen_size[0]-15-10,screen_size[1]/2-30,20,80, None,None,K_DOWN,K_UP)])
]
...
def draw():
    ...
    p1_score_text = font[72].render(str(players[0].score),True,(0,255,255))
    p2_score_text = font[72].render(":" +str(players[1].score),True,(0,255,255))
    surface.blit(p1_score_text,(                                         350,20))
    surface.blit(p2_score_text,(screen_size[0]-p2_score_text.get_width()-350,20))
